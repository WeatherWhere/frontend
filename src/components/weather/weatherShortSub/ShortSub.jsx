                            ...
                            <TD colSpan="12" >
                                <ChartContainer>
                                    <LineChart data={data} width={900} height={50}>
                                        <Line type="linear" dataKey="wav" stroke="#A4B9F2" strokeWidth={2}
                    ...
                    <tbody >
                        ...
                        <tr>
                            ...
                            <TD colSpan="12" >
                                <ChartContainer>
                                    <LineChart data={data} width={900} height={50}>
                                        <Line type="linear" dataKey="vec" stroke="#A8F2A4" strokeWidth={2}
                                            curve="linear" legendType="none" dot={{ r: 5 }} />
                                    </LineChart>
                                </ChartContainer>
                            </TD>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <TD colSpan="12" >
                                <ChartContainer>
                                    <LineChart data={data} width={900} height={50}>
                                        <Line type="linear" dataKey="uuu" stroke="#A4F2F0" strokeWidth={2}
                                            curve="linear" legendType="none" dot={{ r: 5 }} />
                                    </LineChart>
                                </ChartContainer>
                            </TD>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <TD colSpan="12">
                                <ChartContainer>
                                    <LineChart data={data} width={900} height={50}>
                                        <Line type="linear" dataKey="pcp" stroke="#A4DCF2" strokeWidth={2}
                                            curve="linear" legendType="none" dot={{ r: 5 }} />
                                    </LineChart>
                                </ChartContainer>
                            </TD>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <TD colSpan="12">
                                <ChartContainer>
                                    <LineChart data={data} width={900} height={50}>
                                        <Line type="linear" dataKey="sno" stroke="#A4DCF2" strokeWidth={2}
                                            curve="linear" legendType="none" dot={{ r: 5 }} />
                                    </LineChart>
                                </ChartContainer>
                            </TD>
