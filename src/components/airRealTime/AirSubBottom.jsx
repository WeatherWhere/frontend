                        ...
                        <Table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <TD>
                                        <StyledIcon name={getAirQuality(airRealtimeData.pm10Grade)[0]}
                                            color={getAirQuality(airRealtimeData.pm10Grade)[1]} size="2rem" />
                                    </TD>
                                    <TD>
                                        <StyledIcon name={getAirQuality(airRealtimeData.pm25Grade)[0]}
                                            color={getAirQuality(airRealtimeData.pm25Grade)[1]} size="2rem" />
                                    </TD>                                    
                                    <TD>
                                        <StyledIcon name={getAirQuality(airRealtimeData.khaiGrade)[0]}
                                            color={getAirQuality(airRealtimeData.khaiGrade)[1]} size="2rem" />
                                    </TD>                                       
                                    <TD>
                                        <StyledIcon name={getAirQuality(airRealtimeData.coGrade)[0]}
                                            color={getAirQuality(airRealtimeData.coGrade)[1]} size="2rem" />
                                    </TD>
                                    <TD>
                                        <StyledIcon name={getAirQuality(airRealtimeData.o3Grade)[0]}
                                            color={getAirQuality(airRealtimeData.o3Grade)[1]} size="2rem" />
                                    </TD>
                                    <TD>
                                        <StyledIcon name={getAirQuality(airRealtimeData.so2Grade)[0]}
                                            color={getAirQuality(airRealtimeData.so2Grade)[1]} size="2rem" />
                                    </TD>
                                </tr>
                            </tbody>
                        </Table>
